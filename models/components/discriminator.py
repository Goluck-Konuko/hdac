...
class DownBlock2d(nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, norm: bool=False,
                         kernel_size: int=4, pool: bool=False, sn=False) -> None:
...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_channels=3, block_expansion=64, num_blocks=4, max_features=512,
                 sn=False, use_kp=False, num_kp=10, kp_variance=0.01,base_layer=False, estimate_jacobian=False):
